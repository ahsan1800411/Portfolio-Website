...
const ProjectItem = ({ title, url, image, skill }) => {
  return (
    <div className='relative flex items-center justify-center w-full h-[300px] p-4 shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-[#5651e5] to-[#709dff]'>
      <Image
        src={image}
        alt='/'
